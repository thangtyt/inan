...
module.exports = {
    ...
    facebook:{
        ...
        CALLBACK_URL : 'http://localhost:8002/api/auth/facebook/callback'
    },
    ...
    google:{
        ...
        CALLBACK_URL : 'http://localhost:8002/api/auth/google/callback'
    },
    ...
    //set time expires for token
    jwt:{
        timeExpires: '10h', // 600000 milisecond = 10 minute
        jwtSecretKey: 'tkbook_jwt_secret'
    }
