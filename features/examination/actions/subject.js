...
module.exports = function (action, comp, app) {
    ...
    action.sCount = function (conditions) {
        return app.models.subject.count(conditions);
    };
    action.sDelete = function (conditions) {
        return app.models.subject.destroy(conditions);
    };
    //chapter actions
